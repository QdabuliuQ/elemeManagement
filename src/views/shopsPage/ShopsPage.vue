      ...
      <el-table
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            ...
            <el-button size="mini" icon="el-icon-circle-plus-outline" type="success">添加</el-button>
  ...
  methods: {
    location() {  // 获取定位
      getLocation().then(res => {
        ...
        this.shopsDetail(this.cityDetail.latitude, this.cityDetail.longitude, this.shopsSetting.offset, this.shopsSetting.limit)
      })
    },
    shopsDetail(lat, lon, offset, limit) {  // 获取店铺数据
